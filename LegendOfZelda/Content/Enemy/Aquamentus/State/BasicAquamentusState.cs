...
{
    class BasicAquamentusState : IAquamentusState
    {
        public virtual IAquamentus aquamentus { get; set; }
        ...
        */
        ...
        {
            aquamentus.state = new MoveAquamentusState(aquamentus, position, sprite);
        }
