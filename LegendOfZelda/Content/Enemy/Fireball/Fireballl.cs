...
{
    public class Fireball : IFireball
    {
        public IFireballState state{ get; set; }
        private ISprite sprite;

        public Fireball(Game1 game, Vector2 position)
        {
            this.state = new NormalFireballState(this, position, sprite);
        }
